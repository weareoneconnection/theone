...
const apiRoutes = [
  ...
  'GET /api/theone/final-state',
  'GET /api/theone/final-state/runtime',
  'GET /api/theone/final-state/identity',
  'GET /api/theone/final-state/marketplace',
  'POST /api/theone/final-state/simulation',
  'GET /api/theone/final-state/bridge-mesh',
  'GET /api/theone/final-state/memory-graph',
  'GET /api/theone/final-state/self-evolution',
